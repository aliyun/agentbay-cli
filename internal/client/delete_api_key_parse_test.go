...
func TestParseDeleteApiKeyResponse_JSONHttpStatusCodeAsString(t *testing.T) {
	t.Parallel()
	body := `{"Code":"OK","HttpStatusCode":"200","RequestId":"R1","Success":true}`
	res := map[string]interface{}{"body": body, "statusCode": 200}
	out, err := parseDeleteApiKeyResponse(res)
...
func TestParseDeleteApiKeyResponse_JSONHttpStatusCodeAsNumber(t *testing.T) {
	t.Parallel()
...
func TestParseDeleteApiKeyResponse_XML(t *testing.T) {
	t.Parallel()
	body := `<DeleteApiKeyResponse>` +
