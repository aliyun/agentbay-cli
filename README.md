...
| Image   | `list`, `init`, `create`, `create-from-template`, `activate`, `deactivate`, `delete`, `status`, `set-max-session`, `set-pre-open`, `describe-pre-open`, `warmup-status` | Image lifecycle  | [→](docs/en/image.md)   |
